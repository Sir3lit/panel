...
const Label = styled.label`${tw`uppercase text-xs mt-1 text-neutral-250 block px-1 select-none transition-colors duration-150`}`;
    ...
    return (
        <GreyRowBox $hoverable={false} css={tw`flex-wrap md:flex-no-wrap mt-2`}>
            <div css={tw`flex items-center w-full md:w-auto`}>
                <div css={tw`pl-4 pr-6 text-neutral-250`}>
